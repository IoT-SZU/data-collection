...
import cn.ac.futurenet.data_collection.utils.SignalDetect;
...
public abstract class SignalDetectBaseActivity extends WearableActivity implements SignalDetect.OnDetectSignalListener {
    ...
    public SignalDetectBaseActivity(int[] sensorType) {
        super();
        touchScreen = 0;
        isDetectingSignal = false;
        signalDetect = new SignalDetect(sensorType[0], sensorType, 100, new TouchInterceptor());
    }
