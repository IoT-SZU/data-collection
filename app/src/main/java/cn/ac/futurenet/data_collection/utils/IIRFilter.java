...
public class IIRFilter {
     ...
     * 高通 20Hz/100Hz 参数
     */
    private static float[] hA = {1.0000f, -0.3695f, 0.1958f};
    private static float[] hB = {0.3913f, -0.7827f, 0.3913f};

    /**
     * 高通 40Hz/100Hz 参数
     */
    private static float[] hA40 = {1.0000f, 1.1430f, 0.4128f};
    private static float[] hB40 = {0.0675f, -0.1349f, 0.0675f};
